...
+ Let’s just create a short text file from the console(you can copy the following commands to your terminal at one time or use wget command to download it from "https://raw.githubusercontent.com/ZhangNingSAU/Spring-2020-CSCI-185-Script-Programming/master/Resources/small.txt"):
